            ...
            <div className="text-center ">
              <div className="flex flex-col items-center ">
                <h1 className="text-5xl font-bold leading-tight dark:text-white">
                  {" "}
                  Last <span className="text-blue-500">Activities</span>{" "}
                </h1>
                            ...
                            <div className="relative z-20 ">
                              <div className="flex flex-wrap items-center">
                                ...
                                <div className="flex-1 p-4 pr-4 border-l border-gray-300 dark:border-gray-700">
                                  <div className="flex items-center mt-4 justify-between">
                                    <div className="flex items-center">
                                      <div className="icon bg-yellow-400 p-4 rounded-full mr-4 text-xl font-bold text-white">
                                        NA
                                      </div>
                                      <div>
                                        <span>
                                          NuveCore A. changed who can access
                                          this project
                                        </span>
                                        <div className="flex items-center mt-2">
                            ...
                            <div className="relative z-20 ">
                              <div className="flex flex-wrap items-center">
                                ...
                                <div className="flex-1 p-4 pr-4 border-l border-gray-300 dark:border-gray-700">
                                  <div className="flex items-center mt-4 justify-between">
                                    <div className="flex items-center">
                                      <div className="icon bg-red-400 p-4 rounded-full mr-4 text-xl font-bold text-white">
                                        MY
                                      </div>
                                      <div>
                                        <span>
                                          This website page developed by Murat
                                          Yanaşoğlu
                                        </span>
                                        <div className="flex items-center mt-2">
                                          <span className="text-sm mr-2">
                            ...
                            <div className="relative z-20 ">
                              <div className="flex flex-wrap items-center">
                                ...
                                <div className="flex-1 p-4 pr-4 border-l border-gray-300 dark:border-gray-700">
                                  <div className="flex items-center mt-4 justify-between">
                                    <div className="flex items-center">
                                      <div className="icon bg-green-400 p-4 rounded-full mr-4 text-xl font-bold text-white">
                                        FD
                                      </div>
                                      <div>
                                        <span>
                                          This website page has been validated
                                          by Firat Dikmen
                                        </span>
                                        <div className="flex items-center mt-2">
                                          <span className="text-sm mr-2">
                                ...
                                <div className="flex-1 p-4 pr-4 border-l border-gray-300 dark:border-gray-700">
                                  <div className="flex items-center mt-4 justify-between">
                                    <div className="flex items-center">
                                      ...
                                      <div>
                                        <span>
                                          Nuvecore delivered the project.
                                        </span>
                                        <div className="flex items-center mt-2">
                                          <span className="text-sm mr-2">
                                            Do you approve?
